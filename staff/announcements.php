...
$newstr = "_A";
$subcod = $subcode . $newstr;

if (isset($_POST['submit'])) {
    $announ = $_POST['announce'];
    $sq = "insert into announcement(`" . $subcod . "`) values('$announ')";
        ...
        <div class="container">
            ...
            <form method="post">
                <div class="form-group">
                    <textarea class="form-control" rows="3" placeholder="Post an announcement" name="announce"></textarea>
                </div><br>
                <button class="btn btn-primary" type="submit" name="submit">Post</button><br><br>
            </form>
            <!--php script-->
            <?php
            $sql = "select id,`" . $subcod . "` from announcement";
            ...
            if ($result) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="card">
                        <div class="card-body">
                        ' . $announ . '
                        <span style="float:right;"><button class="btn btn-danger"><a href="del.php?deleteid=' . $id . '" class="text-light">X</a></button></span>
                        </div>
