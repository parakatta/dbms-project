...
<body>
  <section>
    ...
    <div class="container">
      ...
      if ($sub1 < 75 || $sub2 < 75 || $sub3 < 75 || $sub4 < 75 || $sub5 < 75 || $sub6 < 75) {
        echo '<h4 class="red">You have shortage of attendance in one of the subjects!</h4>
          <small class="red">*less than 75% </small>';
      }
      ?>
